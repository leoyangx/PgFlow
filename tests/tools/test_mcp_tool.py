...
from pgflow.agent.tools.mcp import MCPToolWrapper, connect_mcp_servers
from pgflow.agent.tools.registry import ToolRegistry
from pgflow.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("pgflow.agent.tools.mcp.logger.warning", _warning)
