  ...
  "channels": {
    "telegram": {
      ...
      <ol>
        ...
        <li>或通过环境变量指定配置路径：<span class="doc-code">PGFLOW_CONFIG=~/.pgflow/config-work.json pgflow gateway</span></li>
      </ol>
...
def _get_status() -> dict:
    from pgflow import __version__
...
def _get_logs() -> dict:
    from pgflow.config.paths import get_logs_dir
