...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.pgflow/workspace"
...
class Config(BaseSettings):
    ...
    def _match_provider(
        ...
        from pgflow.providers.registry import PROVIDERS, find_by_name
    ...
    model_config = ConfigDict(env_prefix="PGFLOW_", env_nested_delimiter="__")
